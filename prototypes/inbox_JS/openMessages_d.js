...
function loader_d() {
    ...
    //Diese EventListener registrieren das Öffnen der Messages für alle Messages
...
function openMessenger_d(event) {
    ...
    if (grundContainer_d.querySelector("#profilNameMessage_d").innerHTML == "WMF Töpferverband") {

        document.getElementById("messagesDetail2_d").style.display = "none";
        document.getElementById("messagesDetail_d").style.display = "flex";



        document.getElementById("messagesDetail_d").style.transition = "left 0s 1s";
    ...
    if (grundContainer_d.querySelector("#profilNameMessage_d").innerHTML == "Fliegendes Klassenzimmer") {

        document.getElementById("messagesDetail_d").style.display = "none";
        document.getElementById("messagesDetail2_d").style.display = "flex";

        document.getElementById("messagesDetail2_d").style.width = "40%";
        document.getElementById("messagesDetail2_d").style.transition = "left 0s 1s";
        document.getElementById("messagesDetail2_d").style.left = "55%";
